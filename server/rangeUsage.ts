...
// Task 2 wires this module into insights.ts/explore.ts/content.ts/activity.ts;
// the project page reaches it through the Insights engine, #305).
//
...
// activity.ts) supply the `db` handle, a scope WHERE
