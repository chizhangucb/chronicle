...
**Inspired by:** [Mantra](https://mantra.gonewx.com) — AI Coding Sessions Time Machine
...
- **FR-SK-14** **Takeover safety** — four-step atomic op with dual-branch rollback (BACKUP → COPY → CLEANUP → SYMLINK); backups retain last 5, integrity-verified; two-level external-source warnings (amber = under HOME outside tool dirs → cleaned + backed up to `~/.mantra/backups/`; red = system path → not cleaned, copy only); confirmation checkbox before external cleanup; safety allowlist restricts cleanup to `$HOME/`.
...
- **NFR-9 Internationalization.** At least English + one additional locale (Mantra ships English + Simplified Chinese); build i18n in from the start.
...
Ordered to reach the "aha" moment fastest, then layer control-plane and advanced capabilities. (Mirrors Mantra's own release history as a proven sequence.)
...
3. **Share links.** Mantra's share links imply *some* hosting. Do we build an in-house share service, or ship export-file-only for v1 to preserve zero-backend?
...
5. **Licensing / build-vs-adopt.** Mantra's core is free; confirm whether an in-house build is warranted vs. adopting/extending, given the substantial control-plane surface area.
6. **Enterprise deployment.** Network proxy support and managed deployment are referenced by Mantra — are these in scope for our internal rollout?

---

## Appendix A — Source references

All requirements are derived from Mantra's public site and documentation (read 2026-07-03):

- Home — https://mantra.gonewx.com/#features
- Docs home — https://docs.mantra.gonewx.com/en/
- Getting Started — https://docs.mantra.gonewx.com/en/guide/getting-started.html
- Time Travel — https://docs.mantra.gonewx.com/en/features/time-travel.html
- Replay Mode — https://docs.mantra.gonewx.com/en/features/replay.html
- Project Management — https://docs.mantra.gonewx.com/en/features/project-management.html
- Context Causality — https://docs.mantra.gonewx.com/en/features/context-causality.html
- MCP Hub — https://docs.mantra.gonewx.com/en/features/mcp-hub.html
- Skills Hub — https://docs.mantra.gonewx.com/en/features/skills-hub.html
- Session Live Streaming — https://docs.mantra.gonewx.com/en/features/live-streaming.html
- Remote SSH Access — https://docs.mantra.gonewx.com/en/features/remote-ssh.html
- Modes — https://docs.mantra.gonewx.com/en/features/modes.html
- Message Filtering — https://docs.mantra.gonewx.com/en/features/filtering.html
- Content Redaction — https://docs.mantra.gonewx.com/en/features/redaction.html
- Compatibility — https://docs.mantra.gonewx.com/en/reference/compatibility.html
