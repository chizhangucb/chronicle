...
const zh = {
  ...
  'Tool Calls': '工具调用',
  'Errors': '错误',
  'View erroring tool calls in Playback': '在回放中查看出错的工具调用',
  'Call Timeline': '调用时间线',
...
const ja = {
  ...
  'Tool Calls': 'ツール呼び出し',
  'Errors': 'エラー',
  'View erroring tool calls in Playback': 'エラーになったツール呼び出しをプレイバックで見る',
