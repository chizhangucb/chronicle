...
const L = {
  en: {
    ...
    causality: 'Context causality', live: 'Live streaming', autoSync: 'Auto-sync',
    ...
    gitEngine: 'Git snapshot engine', metrics: 'Metrics & contract views',
  ...
  ja: {
    ...
    causality: 'コンテキスト因果', live: 'ライブストリーミング', autoSync: '自動同期',
    security: 'セキュリティと共有',
    shortcuts: 'キーボードショートカット', compat: '互換性', config: '設定',
    privacy: 'プライバシーとデータ',
    overview: '概要', dataModel: 'データモデル', parsers: 'パーサーとインジェスト',
    gitEngine: 'Git スナップショットエンジン', metrics: 'メトリクスと契約ビュー',
...
const sidebar = (p, t) => [
  ...
  { text: t.features, items: [
    ...
    { text: t.autoSync, link: `${p}/guide/auto-sync` },
  ...
  { text: t.architecture, items: [
    ...
    { text: t.metrics, link: `${p}/architecture/metrics-and-contract` },
