...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: { message: 'Released under the Apache License 2.0.', copyright: '© 2026 Chi Zhang · Local-first: no telemetry, no LLM calls, your session data stays on your machine.' },
    nav,
    sidebar,
  },
});
